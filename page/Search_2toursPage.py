...
class Search_2toursPage:
    ...
    def input_departure_city(self):
        # (ПОЗИТИВНЫЙ) ЧЕРЕЗ ВВОД ТЕКСТА В ПОЛЕ "Откуда"
        # города, который есть в списке городов
        # Тестовые данные ввода по полям: (ВАЛИДНЫЕ)
        Откуда = 'Волгоград'
        # Куда = 'Турция'

...
class Search_4toursPage:
    ...
    def input_departure_city(self, Откуда='Волгоград'):
        # (НЕГАТИВНЫЙ) ЧЕРЕЗ ВВОД ТЕКСТА В ПОЛЕ "Куда"
        # страны, которой нет в списке стран для г.Волгоград например Таиланд
        # Тестовые данные ввода по полям:
        # Откуда = 'Волгоград'  # (валидный)
        # Куда = 'Таиланд' (не валидный для Волгограда)
    ...
    def input_arrival_country(self, country='Таиланд'):
        """
        ...
        """
        field = (WebDriverWait(self.__driver, 15).until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="app"]/div/'
        ...
        validation_xpath = ('//*[@id="app"]/div/div[1]/div/div/div/div[1]/'
                            'div[1]/div/div[2]/div/div[2]/div/div')
        try:
            ...
            assert element_text == "Ничего не найдено,"
